...
export function emailLayout(heading: string, lines: string[]): string {
  return `
  <div style="font-family: -apple-system, Segoe UI, Roboto, sans-serif; max-width: 520px; margin: 0 auto; color: #1A2320;">
    <div style="background:#1A2320; padding:20px 24px; border-radius:12px 12px 0 0;">
